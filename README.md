...
当前领域版本：`v0.3.2`（候选），Schema 版本：`0015`。v0.3.1 冻结架构保持不变，作为历史基线可追溯。
...
| Cancel/Archive 治理边界（v0.3.2 候选） | [SVC_WORKFLOW_ARCHITECTURE_V0_3_2.md](docs/architecture/SVC_WORKFLOW_ARCHITECTURE_V0_3_2.md) |
