...
OWNER_USE_CASE = SINGLE_USER_TRUSTED_ADMIN_AGENT
IMPLEMENTATION_AUTHORITY = none
...
- the bounded one-time Principal successor migration already added to V2.
...
Long-term multi-Human governance is deferred, not forbidden. It may be introduced only by a lawful later Product Direction successor or an independent higher authority; no implementation or runtime configuration may silently reinterpret V3 to add it.

## 3. Authority and exact coordinates

```text
SVC_WORKFLOW_BASE_COMMIT = 9ba2d87e94f6d39ffdd6986b5a434546cb91d90c
...
CURRENT_PRODUCT_DIRECTION = SVC_WORKFLOW_PRODUCT_BOUNDARY_V2
SUCCESSOR_PRODUCT_DIRECTION = SVC_WORKFLOW_PRODUCT_BOUNDARY_V3
```
...
#### OBS-V3-001 — Active repository Product Direction and governance

- Subject: `mayf3/svc-workflow` source tree.
- Source revision: `9ba2d87e94f6d39ffdd6986b5a434546cb91d90c`.
...
- Result: V2 is accepted and active on `main`; governance adoption is accepted; the integrity verifier passes; V3 does not exist on the base.
- Provenance: repository paths named above and authoring PR record.

#### OBS-V3-002 — Existing global scheduler surface is broader than V3

- Subject: svc-workflow current source/contract state at the base commit.
- Method: inspect the global/Coordinator query and current-state HTTP Contract and compare them with V2/V3.
...
#### OBS-V3-003 — Existing global Domain administration is not V3-complete
...
- Result: the surface is allowlist/scope based and broader than the V3 minimum; separated permission lifecycle, comprehensive no-self-grant/no-self-owner enforcement, minimum Human/Agent selection directory, and narrowed existing Domain-admin behavior remain unestablished.
- Provenance: `docs/contracts/IDENTITY_PROVISIONING_API_V0.md` and source tree.

#### OBS-V3-004 — auth-service reusable identity primitives and missing child permission supply

- Subject: `mayf3/auth-service` at `0855dc5161309196ef0cddbf9142e22726961956`.
- Method: inspect accepted/frozen identity, Machine Principal, Client, direct-token, resolution, and revoke contracts and compare them with the V3 designated-permission requirement.
...
#### OBS-V3-005 — dsh-agent-core command-route gaps
...
#### OBS-V3-006 — Open and historical authority inventory

- Subject: svc-workflow PRs, branches, worktrees, and uncommitted drafts at authoring start.
- Method: fetch GitHub refs; list all PRs, remote branches, worktrees, and dirty worktrees; search Product Direction, Specs, Architecture, contracts, and reports for trusted-Agent/coordinator/global-admin authority.
- Result: only PR #7 is open in svc-workflow; its Head and replay-closure scope match §3 and are independent. The uncommitted Assistance draft and Principal migration implementation files are outside this Product Direction. No competing V3 or trusted-admin-Agent designation authority was found.
- Provenance: authoring PR gate record.

### 4.2 Claims

#### CLM-V3-001 — V3 requires whole-authority supersession

- Support state: SUPPORTED.
- Supported by: `EVD-V3-001`.
- Claim: replacing Human-root/two-person/Human-OBO governance with repository-designated direct-token Agent governance changes identity, authorization, lifecycle, failure, and security meaning and therefore cannot be an amendment to accepted V2.

#### CLM-V3-002 — Existing implementation is conformance debt, not authority

- Support state: SUPPORTED.
- Supported by: `EVD-V3-002`.
...
#### CLM-V3-003 — Capability-scoped sequencing avoids a common global gate

- Support state: SUPPORTED.
- Supported by: `EVD-V3-003`.
...
#### EVD-V3-001 — Owner decision and governance protocol support supersession

- Source observations: `OBS-V3-001`, `OBS-V3-006`.
- Target: `CLM-V3-001`.
- Relation: SUPPORTS.
- Bound coordinates: svc-workflow base and governance snapshot in §3.
- Strength/sufficiency: sufficient for authority classification.
- Limitations: does not itself accept or activate V3.

#### EVD-V3-002 — Current-source observations support drift classification

- Source observations: `OBS-V3-002`, `OBS-V3-003`, `OBS-V3-004`, `OBS-V3-005`.
- Target: `CLM-V3-002`.
- Relation: SUPPORTS.
...
#### EVD-V3-003 — Split ownership supports capability-scoped children

- Source observations: `OBS-V3-003`, `OBS-V3-004`, `OBS-V3-005`.
- Target: `CLM-V3-003`.
- Relation: SUPPORTS.
- Bound coordinates: exact repository revisions in §3.
...
The dedicated Agent is an actual auth-service Agent Principal and daily runtime actor. V3 selects no UUID or Client ID. Existing business/canary Agents are not reused by default; a later designation authority must identify a newly dedicated Agent and exact Client.
...
V3 records, and does not excuse, these gaps:
...
## 17. Bounded one-time Principal successor migration retained from V2

V3 fully restates the already-accepted bounded exception without creating ordinary reassignment:
...
### DEC-V3-001 — Single-user dedicated Agent operation
...
### DEC-V3-002 — Repository designation replaces runtime grant governance
...
### DEC-V3-003 — Split global permissions remain independent
...
### DEC-V3-004 — Feishu is gated provenance, never authority
...
### DEC-V3-005 — Preserve V2 workflow and one-time successor boundaries

- Decision owner: `mayf3`.
- Decision: retain all V2 workflow, Domain, scheduler, Domain-admin, audit/idempotency, ownership, technology, trade-off, and exact one-time successor limits unless explicitly replaced by DEC-V3-001/002/004.
- Rejected: partial supersession or reader-side composition with V2.
- Owner input remaining: none.

## 20. Normative Contracts

### CTR-V3-001 — Whole-authority lifecycle
V3 MUST remain non-active while proposed/unmerged, MUST replace all V2 meaning only through an atomic accepted transition, and MUST NOT authorize implementation directly.

### CTR-V3-002 — Serial workflow product shape
...
### CTR-V3-005 — Transition actor and atomicity
...
### CTR-V3-006 — Strict normal Domain isolation
...
### CTR-V3-007 — Domain-local views and administration
...
### CTR-V3-008 — Exactly two split global permissions
...
### CTR-V3-009 — Scheduler complete field allowlist
...
### CTR-V3-010 — Scheduler active-current population only
...
### CTR-V3-011 — Scheduler sensitive-content exclusion
...
### CTR-V3-012 — Domain-admin allowed surface
...
### CTR-V3-013 — Domain-admin excluded surface
...
### CTR-V3-014 — No self-grant and no self-Owner
...
### CTR-V3-015 — Dedicated actual Agent actor
...
### CTR-V3-016 — Server-side independent authorization and fail closed
...
### CTR-V3-017 — Trusted designation root contents and activation
...
### CTR-V3-018 — Designation rotation and emergency lifecycle
...
### CTR-V3-019 — Compromise and replacement order
...
### CTR-V3-020 — Exact Feishu ingress gate
...
### CTR-V3-021 — Feishu provenance is not authorization
...
### CTR-V3-022 — End-to-end correlation
...
### CTR-V3-023 — Durable audit coverage
...
### CTR-V3-024 — Audit-before-read and atomic-write failure policy
...
### CTR-V3-025 — Revocation/disablement publication barrier
...
### CTR-V3-026 — Idempotency and outcome reconciliation
...
### CTR-V3-027 — Retention and sensitive audit exclusion
...
### CTR-V3-028 — External ownership and direct-token supply
...
### CTR-V3-029 — Layer and storage trust boundary
...
### CTR-V3-030 — Conformance debt remains unimplemented
...
### CTR-V3-031 — Capability-scoped child authority
...
### CTR-V3-032 — Exact one-time successor scope
...
### CTR-V3-033 — Successor historical immutability and append-only transfer
...
### CTR-V3-034 — Successor atomic NOOP and no durable product surface
...
### ACC-V3-001 — Lifecycle and supersession check
- Contracts: `CTR-V3-001`.
- Method/environment: repository frontmatter/backlink/map review on proposed and later acceptance commits.
- Expected: proposed V3 is inactive; later acceptance changes V2 backlink/map atomically and implementation authority remains none.
- Required evidence: exact Git diffs, reviewed commits, Owner receipt, main merge coordinate.
- Failure condition: proposed V3 is called active/accepted, V2 is partially superseded, or implementation is authorized.

### ACC-V3-002 — Serial-shape negative matrix
- Contracts: `CTR-V3-002`.
...
### ACC-V3-003 — Definition lifecycle matrix
- Contracts: `CTR-V3-003`.
...
### ACC-V3-004 — Instance/history integrity
- Contracts: `CTR-V3-004`.
...
### ACC-V3-005 — Transition authority matrix
- Contracts: `CTR-V3-005`.
...
### ACC-V3-006 — Cross-Domain noninterference
- Contracts: `CTR-V3-006`.
...
### ACC-V3-007 — Domain-local view boundary
- Contracts: `CTR-V3-007`.
...
### ACC-V3-008 — Split-permission anti-alias matrix
- Contracts: `CTR-V3-008`.
...
### ACC-V3-009 — Scheduler schema allowlist
- Contracts: `CTR-V3-009`.
...
### ACC-V3-010 — Scheduler population filter
- Contracts: `CTR-V3-010`.
...
### ACC-V3-011 — Scheduler sensitive-field rejection
- Contracts: `CTR-V3-011`.
...
### ACC-V3-012 — Domain-admin allowed operation matrix
- Contracts: `CTR-V3-012`.
...
### ACC-V3-013 — Domain-admin excluded operation matrix
- Contracts: `CTR-V3-013`.
...
### ACC-V3-014 — Self-grant/self-Owner attacks
- Contracts: `CTR-V3-014`.
...
### ACC-V3-015 — Actual actor anti-forgery matrix
- Contracts: `CTR-V3-015`.
...
### ACC-V3-016 — Disabled/revoked fail-closed matrix
- Contracts: `CTR-V3-016`.
...
### ACC-V3-017 — Root authority activation gate
- Contracts: `CTR-V3-017`.
...
### ACC-V3-018 — Designation lifecycle controls
- Contracts: `CTR-V3-018`.
...
### ACC-V3-019 — Compromise/replacement sequencing
- Contracts: `CTR-V3-019`.
...
### ACC-V3-020 — Feishu exact-ingress matrix
- Contracts: `CTR-V3-020`.
...
### ACC-V3-021 — Feishu provenance/actor separation
- Contracts: `CTR-V3-021`.
...
### ACC-V3-022 — Correlation completeness
- Contracts: `CTR-V3-022`.
...
### ACC-V3-023 — Protected audit coverage
- Contracts: `CTR-V3-023`.
...
### ACC-V3-024 — Audit failure and atomicity
- Contracts: `CTR-V3-024`.
...
### ACC-V3-025 — Publication/commit revocation race
- Contracts: `CTR-V3-025`.
...
### ACC-V3-026 — Idempotency/unknown-outcome matrix
- Contracts: `CTR-V3-026`.
...
### ACC-V3-027 — Audit retention/redaction
- Contracts: `CTR-V3-027`.
...
- Failure condition: early deletion, configurable longer retention under V3, sensitive content, or audit read/export surface.

### ACC-V3-028 — External authority and PR disposition
- Contracts: `CTR-V3-028`.
...
### ACC-V3-029 — Layer/trust bypass scan
- Contracts: `CTR-V3-029`.
...
### ACC-V3-030 — Drift truth check
- Contracts: `CTR-V3-030`.
...
- Failure condition: existing partial implementation is declared V3-compliant by existence, tests, or runtime alone.

### ACC-V3-031 — Slice non-escalation graph
- Contracts: `CTR-V3-031`.
...
### ACC-V3-032 — Exact successor scope drift
- Contracts: `CTR-V3-032`.
...
### ACC-V3-033 — Successor history preservation
- Contracts: `CTR-V3-033`.
...
### ACC-V3-034 — Successor atomic NOOP/surface/gates
- Contracts: `CTR-V3-034`.
...
- Partial V2 amendment: rejected; identity/governance meaning changed and V0 permits only whole-authority supersession.
...
V3 acceptance, if later performed, is docs-only and does not mutate runtime. Existing `GLOBAL_WORKFLOW_COORDINATOR` bindings do not auto-map, alias, or grant either split permission. Activation requires all relevant child authorities and exact designation; absent them, global operations remain fail closed.

Capability rollout is Slice-scoped. Rollback of code/config is owned by each child. Security containment may revoke/rotate Client, disable binding, disable Principal, and record durable audit without creating a replacement authority. Product-direction rollback before runtime implementation is a Git revert of the complete accepted transition. After dependent authorities/implementation exist, a lawful whole-authority successor and child rollback plan are required; V2 is not silently revived.

The retained one-time successor migration keeps its separate production execution gate. PR #7 remains independent. No current HTTP Contract, OpenAPI, SDK, Rust, SQL, migration, test, deployment, auth-service, or dsh-agent-core change is made or authorized here.
